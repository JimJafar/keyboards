...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT] = LAYOUT_60_ansi(
        MT(MOD_LCTL | MOD_LGUI,KC_GESC), KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,        KC_MINS, KC_EQL,  KC_BSPC,
        ...
        LT(_NUMPAD,KC_CAPS),          KC_LALT, KC_LGUI,                            KC_SPC,                                MO(_CODING), KC_RCTL, KC_RALT, MO(_RGB)
    ),
    ...
    [_NAV] = LAYOUT_60_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_HOME,   KC_UP,  KC_END, _______, KC_TILD, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, KC_LEFT, _______, KC_RGHT, _______,  KC_GRV,          _______,
        _______,          _______, _______, _______, _______, _______, KC_PGDN, KC_DOWN, KC_PGUP, _______, _______,            KC_UP,
